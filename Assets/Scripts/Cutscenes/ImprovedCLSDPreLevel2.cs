...
public class ImprovedCLSDPreLevel2 : MonoBehaviour
{
    [System.Serializable]
    ...
    [SerializeField] private float minLineDuration = 2f;
    ...
    void Start() {
        lyricsText = new string[] {
            "l:",
            "l:Hello there, Allen.",
            "r:From what I know, the next challenge is going to be interesting...",
            "r:You know those electric scooters that the mechanical engineering students have been making?",
            "l:Yeah...",
            "r:And you know how they don't really work the way they should?",
            "l:Uh oh...",
            "r:Yeah, so the next challenge uses those...",
            "l:Oh...",
            "l:So that's not ideal...",
            "r:Yeah, I mean, is Donald James really allowing one of the challenges to use scooters that seem to violate the laws of physics?",
            "r:I have no idea how that could possibly fit into a challenge to decide who gets into the game dev program...",
            "l:...",
            "r:Oh... now I get it...",
            "l:Yeah, Love Sees Differences doesn't have realistic physics either...",
            "r:Maybe Professor Donald James is on to something...",
            "r:Unrealistic physics in real life to train people for unrealistic games...",
            "l:I'm sure some game devs have much more important things to focus on than hyper realistic physics...",
            "l:Like adding a coherent story to their game before the deadline...",
            "r:Or adding art because they don't have an artist...",
            "l:Someone's totally going to think this conversation has a deeper meaning...",
            "l:"
        };
