...
public class Level4Intro : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lyrics = new List<string> {
            ...
            "We eliminated a lot of people last time...",
            "This time, we're only eliminating half of you.",
            "This is one of Lan Attis's favorite games, and he's here as a guest for the rest of Spectre Games!",
            "This game is called We Live, We Love, We Lie. Sometimes called Steal or No Steal...",
            "Half of these briefcases are safes, while half are eliminates.",
            "One person will open the briefcase, and the other will have the option to steal or no steal.",
            "The person who opens the briefcase will be allowed to say whatever they want to the other person.",
            "You will have to bluff and deceive to get a safe briefcase.",
            "Good luck, contestants. May Lan bless you all."
        };
